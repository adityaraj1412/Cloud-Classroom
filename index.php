...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		<div class="item">
			<div class="fill" style="background-image:url('images/mka.jpeg');"></div>
			<div class="carousel-caption">
				<h2 style="color: blue;"> Making Learning Easy</h2>
			</div>
		</div>
		<div class="item active">
			<div class="fill" style="background-image:url('images/regis.jpg');"></div>
			<div class="carousel-caption">
				<a href="registrationform"><h2 style="color: black;">Register Today</h2></a>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('images/assess.jpg');"></div>
			<div class="carousel-caption">
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="header">Welcome to Cloud Classroom</h1>
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-6">
			<a href="#">
                    <img class="img-responsive img-portfolio img-hover" src="images/download.png" alt="">
                </a>
		
		</div>
		<div class="col-md-4 col-sm-6">
			<a href="#">
                    <img class="img-responsive img-portfolio img-hover" src="images/xampp.png" alt="">
                </a>
		...
		<div class="col-md-4 col-sm-6">
			<a href="#">
                    <img class="img-responsive img-portfolio img-hover" src="images/mysql.png" alt="">
                </a>
		
		</div>
		<div class="col-md-4 col-sm-6">
			<a href="#">
                    <img class="img-responsive img-portfolio img-hover" src="images/html.png" alt="">
                </a>
		
		</div>
		<div class="col-md-4 col-sm-6">
			<a href="#">
                    <img class="img-responsive img-portfolio img-hover" src="images/apa.png" alt="">
                </a>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<p>The CLOUD CLASSROOMS by <strong>Aditya Raj 12008354</strong> includes:</p>
			<ul>
				<li>Accessible Anywhere, Anytime
				</li>
		...
		<div class="col-md-6">
			<img class="img-responsive" src="images/clo.png" alt="">
		</div>
	</div>
